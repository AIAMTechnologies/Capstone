...
const LeadDetailModal: React.FC<LeadDetailModalProps> = ({ lead, isOpen, onClose }) => {
  ...
  const fields: Array<{ label: string; value: string | number | undefined | null }> = [
    ...
    { label: 'Recommended Dealer', value: lead.recommended_dealer_name || lead.dealer_name_assigned || 'Unassigned' },
    { label: 'Final Dealer', value: lead.final_dealer_selection || lead.dealer_name_assigned || lead.recommended_dealer_name || 'Pending assignment' },
